...
PLAT_INCLUDES		:=	-Iplat/rpi4/include

PLAT_BL_COMMON_SOURCES	:=	drivers/arm/pl011/aarch64/pl011_console.S	\
				plat/rpi4/rpi3_common.c			\
...
BL1_SOURCES		+=	drivers/io/io_fip.c			\
				...
				plat/rpi4/aarch64/plat_helpers.S	\
				plat/rpi4/rpi3_bl1_setup.c		\
				plat/rpi4/rpi3_io_storage.c		\
				plat/rpi4/rpi3_mbox.c
...
BL2_SOURCES		+=	common/desc_image_load.c		\
				...
				plat/common/aarch64/platform_mp_stack.S	\
				plat/rpi4/aarch64/plat_helpers.S	\
				plat/rpi4/aarch64/rpi3_bl2_mem_params_desc.c \
				plat/rpi4/rpi3_bl2_setup.c		\
				plat/rpi4/rpi3_image_load.c		\
				plat/rpi4/rpi3_io_storage.c

BL31_SOURCES		+=	lib/cpus/aarch64/cortex_a72.S		\
				plat/common/plat_psci_common.c		\
				plat/rpi4/aarch64/plat_helpers.S	\
				plat/rpi4/rpi3_bl31_setup.c		\
				plat/rpi4/rpi3_pm.c			\
				plat/rpi4/rpi3_topology.c		\
...
RPI3_ARMSTUB8_BIN	:=	${BUILD_PLAT}/armstub8-gic.bin
...
PLAT_BL_COMMON_SOURCES	+=	plat/rpi4/rpi3_rng.c			\
				plat/rpi4/rpi3_stack_protector.c
endif
...
ifneq (${TRUSTED_BOARD_BOOT},0)
    ...
    BL1_SOURCES		+=	${AUTH_SOURCES}				\
				...
				plat/rpi4/rpi3_trusted_boot.c	     	\
				plat/rpi4/rpi3_rotpk.S
